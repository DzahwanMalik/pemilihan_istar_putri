...
import FormImportUsers from "../molecules/FormImportUsers";
...
const UsersTable = ({ data, onRefresh, getLoading, getError }: Props) => {
  const [searchTerm, setSearchTerm] = useState<string>("");
  const [currentPage, setCurrentPage] = useState<number>(1);
  const rowsPerPage = 10;

  // API Method
  const { removeUser, removeUsers, removeLoading, removeError, removeSuccess } =
    useRemoveData();
  ...
  return (
    <div className="p-4">
      ...
      {/* Form Import Data */}
      <FormImportUsers onRefresh={onRefresh} />
